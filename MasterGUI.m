...
% Last Modified by GUIDE v2.5 09-May-2016 09:53:01
...
while ~done
    ...
    switch N
        case 1
            AC=fillts(AC,'le');
            disp('Linear interpolation for NAN used')
        case 2
            AC=fillts(AC,'ce');
...
% Hints: contents = cellstr(get(hObject,'String')) returns popupmenu_MissingData contents as cell array
%        contents{get(hObject,'Value')} returns selected item from popupmenu_MissingData
...
%        str2double(get(hObject,'String')) returns contents of edit_results_riskfreerate as a double
    ...
    if isempty(handles.model.getBenchmark)
        data = {'Annualized Volatility',[sprintf('%2.2f',100*metrics.annualizedvolatility),'%']; ...
                ...
                'Annualized CVaR',[sprintf('%2.2f',100*metrics.CVaR),'%']; ...
                'Correlation','-'; ...
